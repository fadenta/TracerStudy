...
$email_pengirim = 'alumniucic@gmail.com'; // Isikan dengan email pengirim
$nama_pengirim = 'Admin Ruang Alumni UCIC'; // Isikan dengan nama pengirim
...
$mail->Password = 'ezvolaivppquqbuu'; // Isikan dengan Password email pengirim
$mail->Port = 465;
$mail->SMTPAuth = true;
$mail->SMTPSecure = 'ssl';
...
if(empty($attachment)){ // Jika tanpa attachment
    ...
    if($send){ // Jika Email berhasil dikirim
        echo "<h1>Email berhasil dikirim</h1><br /><a href='index.php?page=kirim_email'>Kembali ke Form</a>";
    }else{ // Jika Email gagal dikirim
        echo "<h1>Email gagal dikirim</h1><br /><a href='index.php?page=kirim_email'>Kembali ke Form</a>";
